...
// import { loadEvents, loadSingleEvent, selectedEvent } from '../../store/actions/event.action';
...
const EventDetail = () => {
  ...
  // console.log("EVENTCCC", eventInfo)
  ...
  // console.log("EVENTS DEL CHARACTER", JSON.stringify(comicList))
  // console.log("EVENT SELECTED: ", eventInfo)
